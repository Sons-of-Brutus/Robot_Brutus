...
def generate_launch_description():
    pkg_share = Path(launch_ros.substitutions.FindPackageShare(package='brutus').find('brutus'))
    default_model_path = pkg_share / 'urdf/brutus_wrapper.urdf.xacro'
